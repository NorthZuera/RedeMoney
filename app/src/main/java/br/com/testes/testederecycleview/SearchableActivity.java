...
import br.com.testes.testederecycleview.provider.SearchableProvider;
...
public class SearchableActivity extends AppCompatActivity implements RecyclerViewOnClickListenerHack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            ...
            mList = (new MainActivity()).getSetCarList(11, 0);
    ...
    public void filterCars( String q ){
        ...
        if( mListAux.isEmpty() ){
            ...
            tv.setText( "Nenhum item encontrado." );
            tv.setTextColor( getResources().getColor( R.color.colorPrimarytext ) );
            tv.setId( R.id.searchEmpty );
            tv.setLayoutParams( new FrameLayout.LayoutParams( FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT )  );
            tv.setGravity(Gravity.CENTER);

            clContainer.addView( tv );
        }
        else if( clContainer.findViewById(R.id.searchEmpty) != null ) {
            clContainer.removeView( clContainer.findViewById(R.id.searchEmpty) );
        }
